 ...
 * {@link http://urt-fis-app01.sovcombank.group:8080/web/conf/#application.Кредитование_физлиц.Кредитный_фронт:form.БанкоDELETEDий_базовый.Кредиты_фл.Процессы.Дистрибутивные.Интерфейсные.Автокредит.Метком.Проверка_данных_клиента}.
